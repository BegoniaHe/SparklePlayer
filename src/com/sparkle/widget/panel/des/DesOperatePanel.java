...
import com.sparkle.widget.button.DesOperateButton;
import com.sparkle.widget.dialog.DesLrcDialog;
import com.sparkle.widget.label.DesOperateLabel;
...
public class DesOperatePanel extends JPanel {
	...
	private void initComponent() {
		...
		DesOperateButton lockButton = new DesOperateButton(
				...
				desLrcDialogMouseListener, this);		lockButton.setBounds(mHideTransliterationBtn.getX() + mHideTransliterationBtn.getWidth()
				+ padding, 0, buttonSize, buttonSize);
